...
### 1. [Как React рендерит: виртуальный DOM, reconciliation и батчинг](/05-react/rendering/)
...
### 2. [Состояние и эффекты: useState и useEffect без магии](/05-react/state-effects/)
...
### 3. [Мемоизация, ссылки и редьюсеры: useMemo, useCallback, useRef, useReducer](/05-react/memo-ref-reducer/)
...
### 4. [Продвинутые хуки: useLayoutEffect, useId, useTransition, useDeferredValue, кастомные хуки](/05-react/advanced-hooks/)
...
### 5. [Управление состоянием: Zustand, Redux Toolkit, TanStack Query](/05-react/state-management/)
...
### 6. [Формы: React Hook Form и Zod](/05-react/forms/)
...
### 7. [Роутинг: React Router v7 и data routers](/05-react/router/)
...
### 8. [Тестирование: Vitest и Testing Library](/05-react/testing-react/)
