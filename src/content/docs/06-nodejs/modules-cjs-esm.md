...
История вопроса: `require(esm)` появился в Node 20.10+/22 за флагом `--experimental-require-module`, без флага заработал в v23 и был бэкпортирован в LTS-линейки — 22.12 и 20.19. То есть на всех актуальных LTS интероп уже двусторонний: на `require(esm)` можно рассчитывать, если модуль синхронный (без топ-левел await).
