...
Правило-мнемоника: **`justify-*` всегда вдоль main, `align-*` всегда вдоль cross** — независимо от направления. `justify-content` в `column`-режиме выравнивает по вертикали. Запомнил это — половина путаницы с flex ушла. Все значения всех flex-свойств с наглядными графиками собраны в классической шпаргалке [CSS Tricks: A Complete Guide to Flexbox](https://css-tricks.com/snippets/css/a-guide-to-flexbox/) — держи её открытой, пока идёшь по этой главе.
...
Если синтаксис ещё не сидит в пальцах — пройди [Flexbox Froggy](https://flexboxfroggy.com/#ru): 24 уровня, каждый закрепляет ровно одно свойство из этой главы. Первоисточник по терминологии — спецификация [CSS Flexible Box Layout Module](https://drafts.csswg.org/css-flexbox-1/).
