...
System Design — область, где «посмотрел туториал» и «понимаешь» — разные вещи. Обязательная параллельная траектория: DDIA Клеппмана, «System Design Interview» Алекса Сю, лекции MIT 6.824 и проектирование вслух — всё по ссылке [«Углубление: первоисточники и лабораторные»](/appendix/deep-dive/).
:::
