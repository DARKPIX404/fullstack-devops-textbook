...
**Streaming как мост.** Тяжёлый динамический блок не должен блокировать статический: оборачивай в `<Suspense>` (подробности — в [главе про streaming](/fullstack-devops-textbook/04-nextjs/streaming-edge/)).
