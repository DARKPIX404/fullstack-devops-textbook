...
**Router Cache (уровень 4)** — уже известный тебе по [главе про стратегии](/04-nextjs/rendering-strategies/) браузерный слой: здесь «старые данные» — это норма дизайна, а не баг.
