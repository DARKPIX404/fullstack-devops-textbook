...
Для обучения — обязательно, один раз, по шагам. В проде бери библиотеку: `openid-client` (Node), Auth.js, Better Auth. Они закрывают PKCE, state, nonce, JWKS-кэширование и десяток менее известных граблей спецификации.
:::
