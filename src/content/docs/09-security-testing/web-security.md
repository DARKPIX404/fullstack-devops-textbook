...
7. **A07 Identification and Authentication Failures.** Брутфорс без лимитов, слабые парольные политики (только «минимум 8» — нормально; «обязательно символ» — нет), сессии без ротации после логина, JWT без expiry. См. главу [Аутентификация](/09-security-testing/auth-jwt-oauth/).
