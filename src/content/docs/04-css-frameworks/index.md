...
Важно сразу обозначить границы. Глубокий Tailwind, Radix и Shadcn уже разобраны в разделе [Стили, a11y, Performance](/07-styling-perf/) — там же лежат CSS Modules, современный CSS и производительность. Здесь мы намеренно не дублируем их, а закрываем всё остальное: что стоит за этими инструментами и какие альтернативы живут рядом.

## Карта раздела

### [Препроцессоры: Sass и PostCSS](/04-css-frameworks/preprocessors/)
...
### [Bootstrap 5 глубоко](/04-css-frameworks/bootstrap/)
...
### [Utility-first: UnoCSS, daisyUI](/04-css-frameworks/utility-alternatives/)
...
### [CSS-in-JS: styled-components, Linaria](/04-css-frameworks/css-in-js/)
...
### [Компонентные библиотеки: MUI, Chakra, Mantine](/04-css-frameworks/component-libraries/)
...
2. **Где работают стили: сборка или рантайм?** Рантайм-стилизация (CSS-in-JS классический) сегодня несёт прямой cost на гидратацию и INP — метрики из [Core Web Vitals](/07-styling-perf/web-vitals/).
