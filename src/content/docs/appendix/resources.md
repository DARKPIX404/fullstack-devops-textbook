...
:::tip[Повторение — тоже инструмент]
Для повторения пройденного держи под рукой два внутренних ресурса учебника: [глоссарий](/appendix/glossary/) — сгруппированный словарь ключевых терминов от Event Loop до SBOM и postmortem, и [сводные вопросы на собеседование](/appendix/interview-questions/) — карта из 18 тем с вопросами, которые реально задают. Если на вопрос отвечаешь вслух с примером из практики — тема закрыта; если нет — ссылка ведёт на главу для повторения.
:::
...
| Mario Casciaro, Luciano Mammino — «Node.js: Паттерны проектирования и производительность» | Backend (месяц 6–9). Паттерны, стримы, масштабирование Node.js. |
...
| Шон П. Кейн, Карл Маттиас — «Docker. Вводный курс» (Docker: Up & Running, 3-е изд.) | Месяц 10–12. Практический Docker от базы до многоступенчатых сборок. |
