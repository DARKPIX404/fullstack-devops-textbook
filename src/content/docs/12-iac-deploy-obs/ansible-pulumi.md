...
Пароли БД и API-токены в репозитории — только в зашифрованном виде. Vault шифрует целые файлы или отдельные значения:
...
Pulumi — IaC-движок, где конфигурация — обычная программа. Инициализация проекта:
