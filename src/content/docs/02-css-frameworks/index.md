...
Важно сразу обозначить границы. Глубокий Tailwind, Radix и Shadcn уже разобраны в разделе [Стили, a11y, Performance](/fullstack-devops-textbook/05-styling-perf/) — там же лежат CSS Modules, современный CSS и производительность. Здесь мы намеренно не дублируем их, а закрываем всё остальное: что стоит за этими инструментами и какие альтернативы живут рядом.

## Карта раздела

### [Препроцессоры: Sass и PostCSS](/fullstack-devops-textbook/02-css-frameworks/preprocessors/)
...
### [Bootstrap 5 глубоко](/fullstack-devops-textbook/02-css-frameworks/bootstrap/)
...
### [Utility-first: UnoCSS, daisyUI](/fullstack-devops-textbook/02-css-frameworks/utility-alternatives/)
...
### [CSS-in-JS: styled-components, Linaria](/fullstack-devops-textbook/02-css-frameworks/css-in-js/)
...
### [Компонентные библиотеки: MUI, Chakra, Mantine](/fullstack-devops-textbook/02-css-frameworks/component-libraries/)
...
2. **Где работают стили: сборка или рантайм?** Рантайм-стилизация (CSS-in-JS классический) сегодня несёт прямой cost на гидратацию и INP — метрики из [Core Web Vitals](/fullstack-devops-textbook/05-styling-perf/web-vitals/).
