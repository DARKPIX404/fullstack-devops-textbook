...
Сетка Bootstrap — float-based изначально, с версии 4 — flexbox, с версии 5.3 — [экспериментальный CSS Grid вариант](https://getbootstrap.com/docs/5.3/layout/grid/). Классическая модель из трёх слоёв:
